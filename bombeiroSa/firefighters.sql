...
--
-- Host: 127.0.0.1
-- Tempo de geração: 21-Ago-2023 às 14:41
...
CREATE TABLE `anamnesegestacional` (
  ...
  `faz_uso_medicacao_sim` tinyint(1) DEFAULT NULL,
  `faz_uso_medicacao_nao` tinyint(1) DEFAULT NULL,
  `nome_medico` varchar(255) DEFAULT NULL,
  `possibilidade_complicacoes_sim` tinyint(1) DEFAULT NULL,
  `possibilidade_complicacoes_nao` tinyint(1) DEFAULT NULL,
  `primeiro_filho_sim` tinyint(1) DEFAULT NULL,
  `primeiro_filho_nao` tinyint(1) DEFAULT NULL,
  ...
  `pressao_evacuar_sim` tinyint(1) DEFAULT NULL,
  `pressao_evacuar_nao` tinyint(1) DEFAULT NULL,
  `ruptura_bolsa_sim` tinyint(1) DEFAULT NULL,
  `ruptura_bolsa_nao` tinyint(1) DEFAULT NULL,
  `inspecao_visual_sim` tinyint(1) DEFAULT NULL,
  `inspecao_visual_nao` tinyint(1) DEFAULT NULL,
  `parto_realizado_sim` tinyint(1) DEFAULT NULL,
  `parto_realizado_nao` tinyint(1) DEFAULT NULL,
  `hora_nascimento` time DEFAULT NULL,
  `sexo_bebe_fem` tinyint(1) DEFAULT NULL,
  `sexo_bebe_mas` tinyint(1) DEFAULT NULL,
...
CREATE TABLE `avaliacaocinematica` (
  `id` int NOT NULL,
  `disturbio_comportamento_sim` tinyint(1) DEFAULT NULL,
  `disturbio_comportamento_nao` tinyint(1) DEFAULT NULL,
  `encontrado_capacete_sim` tinyint(1) DEFAULT NULL,
  `encontrado_capacete_nao` tinyint(1) DEFAULT NULL,
  `encontrado_cinto_sim` tinyint(1) DEFAULT NULL,
  `encontrado_cinto_nao` tinyint(1) DEFAULT NULL,
  `para_brisas_avariado_sim` tinyint(1) DEFAULT NULL,
  `para_brisas_avariado_nao` tinyint(1) DEFAULT NULL,
  `caminhando_cena_sim` tinyint(1) DEFAULT NULL,
  `caminhando_cena_nao` tinyint(1) DEFAULT NULL,
  `painel_avariado_sim` tinyint(1) DEFAULT NULL,
  `painel_avariado_nao` tinyint(1) DEFAULT NULL,
  `volante_torcido_sim` tinyint(1) DEFAULT NULL,
  `volante_torcido_nao` tinyint(1) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE `materiaisdeixadoshospital` (
  ...
  `ttf_adul_qt` int DEFAULT NULL,
  `ttf_infa_qt` int DEFAULT NULL,
  `colar_n_qt` int DEFAULT NULL,
  `colar_pp_qt` int DEFAULT NULL,
  `colar_p_qt` int DEFAULT NULL,
  `tirante_aranha_qt` int DEFAULT NULL,
  `colar_m_qt` int DEFAULT NULL,
  `colar_g_qt` int DEFAULT NULL,
  ...
  `ked_adul_qt` int DEFAULT NULL,
  `ked_infa_qt` int DEFAULT NULL,
...
CREATE TABLE `materiaisutilizadosdescartavel` (
  `id` int NOT NULL,
  `ataduras_qt_8` int DEFAULT NULL,
  `ataduras_qt_12` int DEFAULT NULL,
  `ataduras_qt_20` int DEFAULT NULL,
  ...
  `kits_h_qt` int DEFAULT NULL,
  `kits_p_qt` int DEFAULT NULL,
  `kits_q_qt` int DEFAULT NULL,
  `soro_fisiologico_qt` int DEFAULT NULL,
  `luvas_desc_pares_qt` int DEFAULT NULL,
  `talas_pap_p_qt` int DEFAULT NULL,
  `talas_pap_g_qt` int DEFAULT NULL,
